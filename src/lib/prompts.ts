...
export function buildPrompt(
  ...
  const designSystemText = buildDesignSystemBlock(options.designSystem)
...
${optionRulesText ? `\n${optionRulesText}` : ""}${designSystemText}${instructionsText}
...
function buildDesignSystemBlock(designSystem?: string): string {
