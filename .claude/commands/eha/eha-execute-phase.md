---
description: "EHA execute-phase — Execute a specific project phase from docs/project-docs/foundation/phases/"
---
...
2. **Read Authority Docs:** Read `docs/project-docs/foundation/prd.md`, `docs/project-docs/foundation/product-spec.md`, and `docs/project-docs/foundation/architecture.md`.
