...
| P2 | Deploy & Webmu Cash Engine | 🔴 Not started | Next (revenue-critical) |
...
| P2 | [phase-P2-deploy-webmu-cash-engine.md](phase-P2-deploy-webmu-cash-engine.md) | 🔴 Not started | Deploy to Vercel, key rotation, 3 demo pages, Webmu one-pager, QRIS, sales motion |
